...
import com.dysen.mehttp.network.interceptor.CacheInterceptor
import com.dysen.mehttp.network.interceptor.HeadInterceptor
import com.dysen.mehttp.network.interceptor.logging.LogInterceptor
 ...
 * Info：网络请求构建器，继承BasenetworkApi 并实现setHttpClientBuilder/setRetrofitBuilder方法，
